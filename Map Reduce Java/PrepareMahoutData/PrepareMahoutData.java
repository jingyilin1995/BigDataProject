...
public class PrepareMahoutData {
	...
	public static class PrepareMahoutDataMapper extends Mapper<Object,Text,Text,NullWritable>{
	...
	public static class PrepareMahoutDataReducer extends Reducer<Text,NullWritable,Text,NullWritable>{
