...
public class DistinctCrime {
	...
	public static class DistinctCrimeMapper extends Mapper<Object,Text,Text,NullWritable>{
	...
	public static class DistinctCrimeReducer extends Reducer<Text,NullWritable,Text,NullWritable>{
